...
For more: See [MASTER_SUMMARY.md](MASTER_SUMMARY.md) or open an issue on GitHub.
...
5. **Give feedback** → What was confusing? What would help? [Open issue](https://github.com/IanD25/ds-wiki-transformer/issues)
...
| [MASTER_SUMMARY.md](MASTER_SUMMARY.md) | Full technical deep-dive (for engineers) |
| [USER_GUIDE.md](USER_GUIDE.md) | **← You are here** — High-level workflow |
| [FISHER_PIPELINE_REDESIGN.md](FISHER_PIPELINE_REDESIGN.md) | 6-step pipeline specification (technical) |
| [CLAUDE.md](CLAUDE.md) | Project context for LLM assistants |
...
@software{pfd_2026,
  ...
  author={Darling, Ian},
  year={2026},
  url={https://github.com/IanD25/ds-wiki-transformer}
}
```
